  ...
  return (
    <section className={`${section} ${sectionGlass}`} id="news">
      ...
      <div className="grid grid-cols-1 min-[993px]:grid-cols-[1.2fr_1fr] gap-6 reveal">
        <article className="group relative overflow-hidden bg-white/70 backdrop-blur-glass border border-[rgba(15,47,87,0.10)] rounded-lg shadow-card transition-all duration-[400ms] ease-out hover:-translate-y-1.5 hover:bg-white hover:border-navy-mid/30 hover:shadow-hover">
          ...
          <div className="p-8">
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div className="inline-flex items-center gap-2 text-[12px] font-semibold text-brand-gray"><Icon name="calendar" className="w-4 h-4 text-gold-dark" /> 8 March 2026 · Lucknow Campus</div>
        ...
        <div className="flex flex-col gap-3">
          {events.map((e, i) => (
            <div key={i} className="group flex items-start gap-4 p-5 bg-white/70 backdrop-blur-glass border border-[rgba(15,47,87,0.10)] rounded-[14px] shadow-card cursor-pointer transition-all duration-[400ms] ease-out hover:-translate-y-1.5 hover:bg-white hover:border-navy-mid/30 hover:shadow-hover">
              ...
              <div>
                <div className="font-bold text-[15px] leading-[1.4] text-navy-dark mb-1">{e.title}</div>
