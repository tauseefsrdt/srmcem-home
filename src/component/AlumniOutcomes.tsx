...
import { avatar, logo } from '../utils/placeholder';
        ...
        <div className="relative z-[1] grid grid-cols-2 lg:grid-cols-4 gap-[18px] mb-12">
          {stats.map((s) => (
            ...
            >
              ...
              <div className="text-[12px] font-bold tracking-[1px] uppercase text-white/60">{s.label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="relative z-[1] grid grid-cols-2 lg:grid-cols-4 gap-[18px] mb-12">
          {people.map((p) => (
            ...
            >
              ...
              <div className="text-[11px] font-semibold tracking-[0.5px] text-gold-light">{p.branch}</div>
            </div>
          ))}
        </div>
