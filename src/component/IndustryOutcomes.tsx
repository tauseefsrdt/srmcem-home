...
import { section, sectionHeadCenter, eyebrowCenter, sectionTitle, glassSheen } from '../utils/tw';
  ...
  return (
    <section className={`${section}`} id="placements" aria-label="Industry connect and career outcomes">
      <div className={`${sectionHeadCenter} reveal`}>
        ...
        <p className="mt-[18px] text-base leading-[1.85] container mx-auto text-brand-gray">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-[18px] reveal">
        {stats.map((s) => (
          ...
          >
            ...
            <div className="text-[11px] font-bold leading-[1.5] tracking-[0.5px] uppercase text-brand-gray">{s.label}</div>
          </div>
        ))}
      </div>
    </section>
