          ...
          {heading.map((item: any, index: any) => {
            return (
              <div className="text-center container mx-auto reveal" key={index}>
                <div className="inline-flex justify-center items-center gap-2.5 text-[11px] font-bold tracking-[4px] uppercase mb-[18px] text-navy-mid before:content-[''] before:w-[30px] before:h-0.5 before:bg-gold after:content-[''] after:w-[30px] after:h-0.5 after:bg-gold">Programs Offered</div>
