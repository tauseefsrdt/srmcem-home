...
const CTA = () => {
  return (
    <section className={`${section} relative overflow-hidden bg-[linear-gradient(135deg,#0F2F57_0%,#1B4C7F_100%)] border-y-4 border-gold shadow-soft flex items-center justify-between flex-wrap gap-10`}>
      <span className="pointer-events-none absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.5),transparent)]" aria-hidden />
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_80%_at_88%_20%,rgba(242,184,75,0.22)_0%,transparent_60%),radial-gradient(ellipse_50%_70%_at_5%_90%,rgba(27,76,127,0.5)_0%,transparent_55%)]"></div>
