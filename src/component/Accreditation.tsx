...
export const approvals = [
  {
    ...
    image: "/assets/aicte-approved-Cc5kd9Bh-compressed.webp",
  },
  {
    title: "NBA Approved",
    image: "/assets/nba-accredited-PLq4iGgv-compressed.webp",
  },
  {
    title: "AKTU Affiliated",
    image: "/assets/aktu-affiliated-C4ZSXhhj-compressed.webp",
  },
  {
    title: "LU Recognised",
    image: "/assets/lu-affiliated-O317SHjQ-compressed.webp",
  },
];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {approvals.map((item) => (
            ...
            >
              ...
              <h3 className="text-[13px] font-bold tracking-[1.5px] uppercase text-ink">
                {item.title}
              </h3>
            </div>
          ))}
